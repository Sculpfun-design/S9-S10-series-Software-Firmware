...
void make_settings() {
    ...
    // homing_cycle[1] = new AxisMaskSetting(GRBL, WG, "43", "Homing/Cycle1", DEFAULT_HOMING_CYCLE_1);
    // homing_cycle[0] = new AxisMaskSetting(GRBL, WG, "44", "Homing/Cycle0", DEFAULT_HOMING_CYCLE_0);
