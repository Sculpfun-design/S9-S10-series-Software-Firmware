...
#define BOARD_NAME              "Board:MKS DLC32 V003"
        ...
        #define BOARD_VERSION           "MKS DLC32 CoreXY V1.0"
    #endif
#endif
...
#else
#define FW_NAME                 "Firmware:V2.08(8M.H35.20211227)"
#define FW_VERSION              "V2.08(8M.H35.20211227)"
#endif
...
#define DEFAULE_PORBE_ENABLE                0 // boolean
