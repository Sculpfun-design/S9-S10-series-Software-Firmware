...
void draw_global_popup(const char *text) {
    ...
    com_p2.com_popup_sytle.text.font = &dlc32Font;
    ...
    com_p2.com_btn_sytle.text.font = &dlc32Font;
	...
	com_p2.label_yes = label_for_btn_name(com_p2.btn_yes, com_p2.label_yes, 0, 0, (char *)mc_language.tis_yes);
}
...
void mks_draw_common_popup(char *title, char *line1, char *line2, lv_event_cb_t event_cb_yes, lv_event_cb_t event_cancle) {
    ...
    com_p1.com_popup_sytle.text.font = &dlc32Font;
    ...
    label_for_btn_name(com_p1.btn_yes, com_p1.label_yes, 50, 0, (char *)mc_language.tis_yes);
    ...
    label_for_btn_name(com_p1.btn_cancle, com_p1.label_cancle, 50, 0, (char *)mc_language.tis_cancle);
...
void mks_draw_common_pupup_info(char *title,char *line1, char *line2) {
    ...
    com_p_info.com_popup_sytle.text.font = &dlc32Font;
...
void mks_draw_common_popup_info_com( char *title,  char *line1,  char *line2, lv_event_cb_t event_cb_yes) {
    ...
    com_p_info_com.com_popup_sytle.text.font = &dlc32Font;
    ...
    com_p_info_com.com_btn_sytle.text.font = &dlc32Font;
    ...
    label_for_btn_name(com_p_info_com.btn_yes, com_p_info_com.label_yes, 50, 0, (char *)mc_language.tis_yes);
...
void mks_clean_current_page(lv_obj_t * obj) {
    if(com_p1.mux == true) {global_popup_del();} 
    if(com_p2.mux == true) {common_popup_del();} 
    if(com_p_info.mux == true) {common_pupup_info_del();} 
    if(com_p_info_com.mux == true) {common_popup_com_del();} 
    if(cavre_pupop.mux == true) {cavre_popup_del();} 
    lv_obj_clean(obj);
}

lv_obj_t  *mbox1;
static void event_handler_ms(lv_obj_t * obj, lv_event_t event)
{
...
void set_all_click_status(bool status) {

    switch(mks_ui_page.mks_ui_page) {
        MKS_UI_Logo:    break;   
        MKS_UI_Ready:   draw_read_click(status); break;  
        MKS_UI_Adjust:  draw_power_click(status); break; 
        MKS_UI_Control: draw_move_click(status); break;
        MKS_UI_Caving: break; 
        MKS_UI_Pring : break; 
        MKS_UI_Tool: break;  
        MKS_UI_Wifi: break;   
