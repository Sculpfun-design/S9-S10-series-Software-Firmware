...
void mks_draw_craving(void) {
	...
	label_for_imgbtn_name(mks_global.mks_src_1, label_up, up, 0, 0, mc_language.page_up);
	label_for_imgbtn_name(mks_global.mks_src_1, label_next, next, 0, 0, mc_language.page_dowm);
	...
	if(state == SDState::NotPresent)
	{
		...
		label_for_screen(mks_global.mks_src, Label_NoFile, 0, 0, mc_language.no_sd_card);
	}else {
